...
import type { AdFloor, AdFloorFormData } from '../../../types';
import { useChannelStore } from '../../../store/useChannelStore';
import { useAdFloorStore } from '../../../store/useAdFloorStore';
import dayjs from 'dayjs';

interface AdFloorModalProps {
    open: boolean;
    editingFloor?: AdFloor;
    onClose: () => void;
}

const AdFloorModal: React.FC<AdFloorModalProps> = ({
    open,
    editingFloor,
    onClose,
}) => {
    ...
    const handleOk = async () => {
        try {
            ...
            const formData: AdFloorFormData = {
                title: values.title,
